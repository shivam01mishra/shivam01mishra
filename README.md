...
- **[OS-COMPONENTS-CPP](https://github.com/shivam01mishra/OS-COMPONENTS-CPP)** — a collaborative group project building core OS components in C++: a memory allocator, a CPU process scheduler (FCFS/SJF/Round Robin/priority), and a cooperative user-space thread library so far, with virtual memory, a file system, IPC, and a shell still to come. Forked from [PoojaGoel-IIT/OS-COMPONENTS-CPP](https://github.com/PoojaGoel-IIT/OS-COMPONENTS-CPP).
