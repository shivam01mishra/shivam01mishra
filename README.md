...
- **[OS-COMPONENTS-CPP](https://github.com/PoojaGoel-IIT/OS-COMPONENTS-CPP)** — a collaborative group project building core OS components in C++ (memory manager implemented so far, more in progress).
